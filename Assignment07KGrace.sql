...
-- 2022-11-28,KGrace,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_KGrace')
	 Begin 
	  Alter Database [Assignment07DB_KGrace] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_KGrace;
	 End
	Create Database Assignment07DB_KGrace;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_KGrace;
...
Create  View vProductInventoriesWithPreviousMonthCountWithKPIs
As
 Select
  ProductName
 ,InventoryDate
...
Create Function fProductInventoriesWithPreviousMonthCountsWithKPIs
 ...
 As
  ...
  From vProductInventoriesWithPreviousMonthCounts as v1
